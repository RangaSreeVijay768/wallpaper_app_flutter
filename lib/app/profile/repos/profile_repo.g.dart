...
class _ProfileRestClient implements ProfileRestClient {
  ...
  Future<GetAllProfileImagesResponse> getAllProfileImages(
    ...
    final _options = _setStreamType<GetAllProfileImagesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late GetAllProfileImagesResponse _value;
    try {
      _value = GetAllProfileImagesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
