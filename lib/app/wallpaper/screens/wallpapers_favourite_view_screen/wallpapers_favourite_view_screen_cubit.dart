...
part 'wallpapers_favourite_view_screen_state.dart';

part 'wallpapers_favourite_view_screen_cubit.freezed.dart';

class WallpapersFavouriteViewScreenCubit
    extends BaseCubit<WallpapersFavouriteViewScreenState> {
  ValueNotifier<bool> isSharingNotifier = ValueNotifier(false);
  ValueNotifier<bool> isDownloadingNotifier = ValueNotifier(false);

  WallpapersFavouriteViewScreenCubit({required super.context})
      : super(initialState: WallpapersFavouriteViewScreenState.initial());
