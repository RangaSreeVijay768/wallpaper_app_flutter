...
import 'wallpapers_favorites_profile_view_screen_controller.dart';
import 'wallpapers_favorites_profile_view_screen_cubit.dart';

import '/app/core/widgets/base_stateless_widget.dart';

class WallpapersFavoritesProfileViewScreen
    extends BaseStatelessWidget<WallpapersFavoritesProfileViewScreenController,
        WallpapersFavoritesProfileViewScreenCubit,
        WallpapersFavoritesProfileViewScreenState> {
  final String wallpaperId;
  final List<String> images;
  late ValueNotifier<bool> favouriteNotifier = ValueNotifier<bool>(false);
  WallpapersFavoritesProfileViewScreen(
      {Key? key, super.controller, super.onStateChanged, required this.images, required this.wallpaperId})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<WallpapersFavoritesProfileViewScreenCubit>(
  ...
  @override
  WallpapersFavoritesProfileViewScreenCubit createCubitAndAssignToController(
      BuildContext context) {
    WallpapersFavoritesProfileViewScreenCubit cubit = WallpapersFavoritesProfileViewScreenCubit(
        context: context);
