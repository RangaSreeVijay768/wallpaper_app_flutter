...
import 'wallpapers_view_screen_controller.dart';
import 'wallpapers_view_screen_cubit.dart';

import '/app/core/widgets/base_stateless_widget.dart';

class WallpapersViewScreen
    extends BaseStatelessWidget<WallpapersViewScreenController,
        WallpapersViewScreenCubit,
        WallpapersViewScreenState> {
  final String wallpaperId;
  final List<Images> images;
  late ValueNotifier<bool> favouriteNotifier;

  WallpapersViewScreen({Key? key, super.controller, super.onStateChanged, required this.images, required this.wallpaperId, required this.favouriteNotifier})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<WallpapersViewScreenCubit>(
      create: (context) => createCubitAndAssignToController(context),
      child: BlocConsumer<WallpapersViewScreenCubit, WallpapersViewScreenState>(
            ...
            body: GestureDetector(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  FavoritesService().isFavorite(imageUrl).then((isFavorite) {
  ...
  @override
  WallpapersViewScreenCubit createCubitAndAssignToController(
      BuildContext context) {
    WallpapersViewScreenCubit cubit = WallpapersViewScreenCubit(
        context: context);
